...
public class TrashGenerator : MonoBehaviour
{
    ...
    public int TrashSpread = 25; // Overall size of the forest (a square of forestSize X forestSize).
    ...
    private void Start()
    {
        ...
        for (int x = 0; x < TrashSpread; x += elementSpacing)
        {
            for (int z = 0; z < TrashSpread; z += elementSpacing)
            {
